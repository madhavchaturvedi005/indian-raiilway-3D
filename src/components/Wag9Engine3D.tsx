...
function Locomotive() {
    const { scene } = useGLTF('/assets/wag_9_indian_locomotive_lowpoly_count.glb');
    return <primitive object={scene} />;
}

// Preload to ensure fast rendering when scrolling down
useGLTF.preload('/assets/wag_9_indian_locomotive_lowpoly_count.glb');
...
export default function Wag9Engine3D() {
    return (
        <div className="w-full h-full min-h-[600px] relative cursor-grab active:cursor-grabbing">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 pointer-events-none z-10">
                <div className="bg-white/10 backdrop-blur-md border border-white/20 px-6 py-2 rounded-full text-white/80 text-xs tracking-widest uppercase font-bold flex items-center gap-3 shadow-xl">
